...
export const Icons = {
  ...
  CircleInfo: function CircleInfo(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
        height="18"
        width="18"
  ...
  CubeSettings: function ConnectedDots(props: SVGProps<SVGSVGElement>) {
    return (
      <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g fill="currentColor">
          <line
  ...
  Receipt2: function Receipt2(props: SVGProps<SVGSVGElement>) {
    return (
      <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g fill="currentColor">
          <line
  ...
  Books2: function Books2(props: SVGProps<SVGSVGElement>) {
    return (
      <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g fill="currentColor">
          <rect
  ...
  Users6: function Users6(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
        height="18"
        width="18"
  ...
  Time: Clock,
  Hyperlink: function Hyperlink(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
        height="18"
        width="18"
  ...
  Gear: function Gear(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
        height="18"
        width="18"
  ...
  Gear2: function Gear2(props: SVGProps<SVGSVGElement>) {
    return (
      <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g fill="currentColor">
          <line
  ...
  CursorRays: function CursorRays(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
        height="18"
        width="18"
  ...
  LinesY: (props: SVGProps<SVGSVGElement>) => (
    <svg
      height="18"
      width="18"
      viewBox="0 0 18 18"
