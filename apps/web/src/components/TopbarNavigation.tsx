import useDebouncedCallback from "@/hooks/use-debounded-callback";
import { Popover, PopoverContent, PopoverTrigger } from "@gigflow/ui/popover";
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        For Freelancers
        <PopoverContent
          className="rounded-3xl shadow-3xl flex w-[920px] flex-row divide-x p-8 dark:text-white"
          sideOffset={20}
        >
