...
import { InvoiceCommentsSheet } from "@/components/invoices/sheets/invoice-comments";
import { UTCDate } from "@date-fns/utc";
import { HtmlTemplate } from "@gigflow/invoice/templates/html";
import { verify } from "@gigflow/invoice/token";
import { getInvoiceQuery } from "@gigflow/supabase/queries";
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen dotted-bg p-4 sm:p-6 md:p-0">
      ...
      <div className="fixed bottom-4 right-4 hidden md:block">
        <a
          href="https://gigflow.ai?utm_source=invoice"
          target="_blank"
          rel="noreferrer"
          className="text-[9px] text-[#878787]"
        >
          Powered by <span className="text-primary">Gigflow</span>
        </a>
      </div>
    </div>
  );
